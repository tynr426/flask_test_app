...
!function ($e, win) {
    ...
    //扩展到ECF的插件中进行使用
    $e.fn.page = function (templateId, pageBarId, data, pageSize, callback, callPage) {
    ...
    function showData(pager, data, append) {
        ...
        if (ECF.isArray(data) && data.length > 0) {
            ...
            if (c.isHover && c.container[0].nodeName == 'TBODY') {
                $e(">tr", c.container[0]).each(function(){
                    $e(this).bind("mouseover", function () {
                        $e(">th,>td", this).css("background-color", c.hoverColor);
                    });
                    $e(this).bind("mouseout", function () {
                        $e(">th,>td", this).css("background-color", "");
                    });
                });
            }
        }
