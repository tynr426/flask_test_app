...
var treeGrid = {
    ...
    toggle: function (o) {
        ...
        //    $.each(child, function () {
        //        //获取i标记
        //        ico = $(this).find("i[class='ico']");
        //        if (ico && ico.length > 0 && $(this).hasClass("open")) {
        //            $.each(ico, function () {
...
$.extend($, {
    areas: function(ctlId, secendId, thirdId,fun) {
        var jsonUrl = "/static/js/areas.json",
            win = this.config.win,
            ctl = win.$("#" + ctlId),
            sctl = win.$("#" + secendId),
            tctl = win.$("#" + thirdId),
        ...
        win.$.getScript(jsonUrl, function() {
            areaList = win.chinaAreas;
